...
function renderPlayers() {
  playersList.innerHTML = "";
	...
	#добавил обновление игроков
	countSpan.textContent = player.length;
...
generateBtn.addEventListener("click", () => {
  ...
  const size = teamSizeInput.value(10); 
...
// ── Инициализация ────────────────────────────────────────────
updateTimerDisplay();
renderPlayers(); # добавил начальный список
